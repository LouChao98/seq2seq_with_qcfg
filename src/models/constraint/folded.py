...
class FPenaltyDepth(RuleConstraintBase):
    ...
    def get_weight(self, batch_size, pt_states, nt_states, pt_num_nodes, nt_num_nodes, pt_spans, nt_spans, device):
        ...
        nt_ntnt = node_score[:, nt_idx, nt_idx].view(batch_size, nt_num_nodes, nt_num_nodes)
        nt_ntpt = node_score[:, nt_idx, pt_idx].view(batch_size, nt_num_nodes, pt_num_nodes)
...
class FPenaltyDepthAndNonIntersection(FPenaltyDepth):
    ...
    def get_weight(self, batch_size, pt_states, nt_states, pt_num_nodes, nt_num_nodes, pt_spans, nt_spans, device):
        ...
        nt_ntnt = node_score[:, nt_idx, nt_idx, nt_idx].view(batch_size, nt_num_nodes, nt_num_nodes, nt_num_nodes)
        nt_ntpt = node_score[:, nt_idx, nt_idx, pt_idx].view(batch_size, nt_num_nodes, nt_num_nodes, pt_num_nodes)
        nt_ptnt = node_score[:, nt_idx, pt_idx, nt_idx].view(batch_size, nt_num_nodes, pt_num_nodes, nt_num_nodes)
        nt_ptpt = node_score[:, nt_idx, pt_idx, pt_idx].view(batch_size, nt_num_nodes, pt_num_nodes, pt_num_nodes)
