...
from src.models.posterior_regularization.general import NoManyToOneNT
...
pr_task = NoManyToOneNT()
cc = pr_task.process_constraint(pred)

ec = calculate_e(params_x, seq_inst, N, NT, PT, SRC_NT)
...
ec = calculate_e(cparams, seq_inst, N, NT, PT, SRC_NT)
print("After PR", ec)
