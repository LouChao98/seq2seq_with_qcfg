...
from src.models.tgt_parser.neural_qcfg_decomp1 import NeuralQCFGDecomp1TgtParser
from src.models.tgt_parser.struct.decomp1 import Decomp1
...
tgt_parser = NeuralQCFGDecomp1TgtParser(
    pt_states=2,
    nt_states=2,
    pt_span_range=[1, 1],
...
pcfg_ref = PCFG()
params2 = Decomp1.get_pcfg_rules(params, 2)
